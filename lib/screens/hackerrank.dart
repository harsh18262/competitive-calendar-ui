...
class HackerRank extends StatefulWidget {
  @override
  _HackerRankState createState() => _HackerRankState();
}

class _HackerRankState extends State<HackerRank> {
  Contest contest = Contest();
  // ignore: deprecated_member_use
  List<Article> articles = List<Article>();
  getandSetData() async {
    await contest.getContestDataHackerRank();
